import 'package:quizler2/question.dart';

class QuizBrain {
  int _questionNo = 0;
  List<Question> _questionBank = [
    Question(
        q: 'Watching horror movies doesn’t cause any reaction in your body.',
        a: false),
    Question(q: 'A slug has four noses in total.', a: true),
    Question(q: 'Honeybees are the fastest flying insect.', a: false),
